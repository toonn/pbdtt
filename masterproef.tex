\documentclass[master=cws, oneside]{kulemt} \setup{title={Programmeren en
...
\setup{filingcard, translatedtitle={Programming and Proofs in Dependently Typed
  Languages}, udc=681.3, shortabstract={In this thesis we present two case
    ...
    reliance on test suites by encoding simple properties in your types.}}
...
\begin{preface} Ik heb dit thesisonderwerp gekozen omdat ik erg geïnteresseerd
  ...
  "Hoe kan de C compiler in C geschreven zijn?" Dit maar om aan te geven dat ik
  het een fascinerend onderwerp vind. De interesse in dependent types is
...
\chapter{Red-Black Trees in Agda}
  ...
  Agda om te tonen dat dependent types absoluut niet verplicht zijn.
